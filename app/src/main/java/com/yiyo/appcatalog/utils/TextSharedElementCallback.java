...
public class TextSharedElementCallback extends SharedElementCallback {
    ...
    public TextSharedElementCallback(float initialTextSize,  int initialPaddingStart) {
        ...
        this.initialPaddingStart = initialPaddingStart;
    }
    ...
    public void onSharedElementStart(List<String> sharedElementNames, List<View> sharedElements,
        ...
        targetViewTextSize = targetView.getTextSize();
        targetViewPaddingStart = targetView.getPaddingStart();

        // Setup the TextView's start values.
        targetView.setTextSize(TypedValue.COMPLEX_UNIT_PX, initialTextSize);
        ViewCompat.setPaddingRelative(targetView, initialPaddingStart, targetView.getPaddingTop(),
    ...
    public void onSharedElementEnd(List<String> sharedElementNames, List<View> sharedElements,
        ...
        ViewCompat.setPaddingRelative(initialView, targetViewPaddingStart, initialView.getPaddingTop(),
